...
{
	HINSTANCE hInstance = ::ShellExecute(NULL, _T("open"), _T("C://Users//Dimka//Downloads//Nouse//DVD-4BERGER-2016//NOUSE-Core-C++ 2015 64//Debug//NouseSettings.exe"), NULL, NULL, SW_SHOWNORMAL);
	/*if ((int)hInstance != 32)
	{
	if(hInstance == 0
